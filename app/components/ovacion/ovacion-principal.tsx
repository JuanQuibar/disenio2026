...
interface OvacionPrincipalProps {
  foto: { src: string; alt: string };
}

export function OvacionPrincipal({ foto }: OvacionPrincipalProps) {
  return (
    <div className="mb-2">
      ...
      <div className="">
        <h2 className="font-sans font-bold text-lg leading-snug text-gray-900 mb-1">
